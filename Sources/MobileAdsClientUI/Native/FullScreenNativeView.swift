...
//  MobileAdsClient
//
//  SwiftUI wrapper around `FullScreenNativeAdContainerView`. Plugs a loaded
...
public struct FullScreenNativeView: UIViewRepresentable {
    ...
    public func makeUIView(context: Context) -> FullScreenNativeAdContainerView {
        let view = FullScreenNativeAdContainerView(configuration: configuration)
    ...
    public func updateUIView(
        _ view: FullScreenNativeAdContainerView,
        context: Context
    ) {
